...
const AboutUs = () => {
    ...
    return (
        <div className="AboutUs-page">
            ...
            <p style={{ fontSize: '20px', marginTop: '50px'}}>Empowering Change Student Leaders Committed to the Equitable <br></br> Distribution of Harm Reduction Service Nationwide</p>
