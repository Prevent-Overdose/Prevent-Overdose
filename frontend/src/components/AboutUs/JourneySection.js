...
const JourneySection = () => {
  ...
  const journeyData = [
    ...
    { title: "We Secure Narcan Distribution Designation", date: "January 2023", description: "After months of paperwork, Prevent Overdose Inc. was officially designated as a Narcan-distributing organization through a funding mechanism from the Florida Department of Children and Families (DCF)." },
